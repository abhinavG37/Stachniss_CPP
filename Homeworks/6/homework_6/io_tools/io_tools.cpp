...
//====                   Constructors                   =====
//===========================================================
ImageData::ImageData(): rows{0}, cols{0}, max_val{0}, data{std::vector<uint8_t>(0,0)}{
  std::cout<<"Default Constructor Created"<<std::endl;
}

ImageData::ImageData(int rowVals, int colVals, uint8_t max_val_, std::vector<uint8_t> data_val):
                   rows{rowVals}, cols{colVals}, max_val{max_val_}, data{data_val}{
  std::cout<<"ImageData Struct Created from Input"<<std::endl;
}
